...
window.onload = function () {
  mainTutorialElement.classList.add(
    "animate__animated",
    "animate__fadeIn",
    "animate__slower"
  );
...
function openRecordTutorial() {
  ...
  recordTutorialElement.classList.replace(
    "animate__fadeOut",
    "animate__fadeIn"
  );
...
function closeUploadCheckPop() {
  ...
  setTimeout(function () {
    popUpUploadElement.classList.remove(
      "animate__animated",
      "animate__zoomOut"
    );
    document.all.backGround.style.visibility = "hidden";
...
function closeDeletePop() {
  ...
  setTimeout(function () {
    popUpDeleteElement.classList.remove(
      "animate__animated",
      "animate__zoomOut"
    );
    document.all.backGround.style.visibility = "hidden";
...
function audioManipulation(audioURL, uploadMode, recordTime) {
  ...
  playbutton.onclick = function (e) {
    ...
    setTimeout(function () {
      playbtnElement.classList.remove(
        "animate__animated",
        "animate__pulse",
        "animate__slower"
      );
  ...
  pausebutton.onclick = function (e) {
    ...
    setTimeout(function () {
      pausebtnElement.classList.remove(
        "animate__animated",
        "animate__pulse",
        "animate__slower"
      );
  ...
  audio.addEventListener("durationchange", function (e) {
    ...
    if (uploadMode == true) {
      ...
      $("#timer").html(
        parseInt(audioMin / 10) +
          "" +
          parseInt(audioMin % 10) +
          ":" +
          parseInt(audioSec / 10) +
          "" +
          parseInt(audioSec % 10)
      );
    }
...
function switchingPage() {
  ...
  setTimeout(function () {
    ...
    if (tryNum == 0) {
      document.all.timer.style.visibility = "hidden";
      recordTutorialElement.classList.add(
        "animate__animated",
        "animate__fadeIn",
        "animate__slower"
      );
